`Note:` EEG connectivity (including this README.md) was cloned from [https://github.com/pwittchen/neurosky-android-sdk.](https://github.com/pwittchen/neurosky-android-sdk)
